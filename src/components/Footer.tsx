      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-2">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent">TechnoClub</h2>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Empowering students through technology and innovation. Join our community and explore the future together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Clubs', 'Events', 'Team', 'Contact'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Campus Drive, University Area</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-center">
            © {new Date().getFullYear()} TechnoClub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
